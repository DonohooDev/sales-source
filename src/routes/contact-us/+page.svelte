...
<GridBackgroundWrapper>
    <section class="content-lg">
        ...
        <p class="text-subtitle">
            We are here to help you with any questions you may have. Please feel free to reach out
            to us at any time.
        </p>

        <form class="form content-xs">
            <div class="grid grid-col grid-cols-1 auto-rows-auto gap-x-6 gap-y-8 sm:grid-cols-2">
                ...
                <div class="sm:col-span-2">
                    ...
                    <p class="mt-3 text-sm leading-6 text-gray-600">
                        Write a few sentences about your situation and how we can help.
                    </p>
                </div>
            </div>
        </form>
