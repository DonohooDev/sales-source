...
<GridBackgroundWrapper>
    <section class="content-lg">
        ...
        <p class="text-subtitle">
            Our code of conduct and your pledge to be an upstanding member of our services.
        </p>

        <div class="content">
            <h2 id="introduction" class="text-h3">Introduction</h2>
            <p>
                At Sales Source, accessible from salessource.com, one of our main priorities is the
                privacy of our visitors. This Privacy Policy document contains types of information
                that is collected and recorded by Sales Source and how we use it. If you have
                additional questions or require more information about our Privacy Policy, do not
                hesitate to contact us. This Privacy Policy applies only to our online activities
                and is valid for visitors to our website with regard to the information that they
                shared and/or collect in Sales Source. This policy is not applicable to any
                information collected offline or via channels other than this website.
            </p>

            <h2 id="consent" class="text-h3">Consent</h2>
            <p>
                By using our website, you hereby consent to our Privacy Policy and agree to its
                terms.
            </p>

            <h2 id="information-collection" class="text-h3">Information we collect</h2>
            <p>
                ...
                your personal information. If you contact us directly, we may receive additional
                information about you such as your name, email address, phone number, the contents
                of the message and attachments you may send us, and any other information you may
            ...
            <h2 id="information-use" class="text-h3">How we use your information</h2>
            ...
            <h2 id="log-files" class="text-h3">Log Files</h2>
            <p>
                Sales Source follows a standard procedure of using log files. These files log
            ...
            <h2 id="cookies" class="text-h3">Cookies and Web Beacons</h2>
            <p>
                Like any other website, Sales Source uses 'cookies'. These cookies are used to store
            ...
            <h2 id="advertising" class="text-h3">Advertising Partners Privacy Policies</h2>
            <p>
                You may consult this list to find the Privacy Policy for each of the advertising
                partners of Sales Source. Our Privacy Policy was created with the help of the
                Privacy Policy Generator and the Privacy Policy Generator Online. Third-party ad
                servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons
                that are used in their respective advertisements and links that appear on Sales
                Source, which are sent directly to users' browser. They automatically receive your
            ...
            <h2 id="third-party" class="text-h3">Third Party Privacy Policies</h2>
            <p>
                Sales Source's Privacy Policy does not apply to other advertisers or websites. Thus,
                ...
                instructions about how to opt-out of certain options. You can choose to disable
                cookies through your individual browser options. To know more detailed information
                about cookie management with specific web browsers, it can be found at the browsers'
                respective websites.
            </p>

            <h2 id="privacy-rights" class="text-h3">
            ...
            <h2 id="gdpr" class="text-h3">GDPR Data Protection Rights</h2>
            <p>
            ...
            <h2 id="child-information" class="text-h3">Children's Information</h2>
            <p>
                Another part of our priority is adding protection for children while using the
                internet. We encourage parents and guardians to observe, participate in, and/or
                monitor and guide their online activity. Sales Source does not knowingly collect any
                Personal Identifiable Information from children under the age of 13. If you think
                that your child provided this kind of information on our website, we strongly
